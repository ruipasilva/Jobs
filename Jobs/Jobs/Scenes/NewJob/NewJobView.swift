...
struct NewJobView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .onChange(
                of: newJobViewModel.addInterviewToCalendar,
                { _, _ in
                    Task {
    ...
    private var mainInfoView: some View {
        Section {
            FloatingTextField(
                title: "Company Name", text: $newJobViewModel.company,
                image: "building.2"
            )
            .submitLabel(.next)
            ...
            FloatingTextField(
                title: "Job Title", text: $newJobViewModel.title,
                image: "person"
            )
    ...
    private var locationView: some View {
        Section {
            Picker(
                "Job Type", selection: $newJobViewModel.locationType.animation()
            ) {
    ...
    private var remindersView: some View {
        Section {
            ...
            Toggle(
                ...
                isOn: $newJobViewModel.addInterviewToCalendar.animation())
            ...
            if newJobViewModel.addInterviewToCalendar {
                ...
                DatePicker(
                    ...
                    in: Date.now...,
                    displayedComponents: newJobViewModel.isEventAllDay
            ...
            Text(
                "A Follow up will send a local notification to your device. Adding to calendar will create an event in the Calendar app."
            )
        }
    }
    ...
    private var recruitersInfoView: some View {
        Section {
            FloatingTextField(
                title: "Name",
                text: $newJobViewModel.recruiterName,
                image: "person.circle"
            )
            ...
            FloatingTextField(
                title: "Email",
                text: $newJobViewModel.recruiterEmail,
                image: "envelope"
            )
            ...
            FloatingTextField(
                title: "Number",
                text: $newJobViewModel.recruiterNumber,
                image: "phone"
            )
    ...
    private var otherInfoView: some View {
        Section {
            FloatingTextField(
                title: "Salary",
                text: $newJobViewModel.salary,
                image: "creditcard"
            )
            .keyboardType(.numberPad)
            FloatingTextField(
                title: "URL", 
                text: $newJobViewModel.url,
                image: "link"
            )
            .submitLabel(.next)
            .onSubmit {
